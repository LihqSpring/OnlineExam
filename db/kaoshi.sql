...
MySQL - 5.6.28-log : Database - test
*********************************************************************
*/
...
insert  into `t_manager`(`id`,`name`,`password`,`userName`) values (1,'管理员','admin','admin');
...
insert  into `t_paper`(`id`,`joinDate`,`paperName`) values (1,'2014-01-01 00:00:00','Java试卷一'),(2,'2014-02-01 00:00:00','语文试卷二'),(3,'2014-01-01 00:00:00','数学试卷一'),(7,'2018-04-27 00:00:00','计算机基础知识'),(9,'2018-04-28 00:00:00','大学英语');
...
insert  into `t_student`(`id`,`cardNo`,`name`,`password`,`prefession`,`sex`) values ('JS123','213213213','张三3','12323','计算机3','男'),('JS20140704052827','fa','测试账号','fda','fda','男'),('JS20140710074259','12321321321','张三','123456','计算机','男'),('JS20140827083933','123','小二','123456','电气化','男'),('JS20180427104336','62626565656','李四','1','计算机','女');
